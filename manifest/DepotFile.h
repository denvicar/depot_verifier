...
enum EDepotFileFlag { Directory = 64, Executable = 32 };

class DepotFile {
public:
  DepotFile(DepotManifest dm, ContentManifestPayload_FileMapping fm)
      : manifest(dm), file_mapping(fm) {}
