...
//			if (mz_zip_reader_extract_to_mem(&zip, 0,
// decompressedContent.data(), decompressedContent.size(), 0) == MZ_TRUE) {
// mz_zip_reader_end(&zip); 				return
// decompressedContent;
//			}
//		}
//	}
...
DepotManifest::DepotManifest(vector<uint8_t> d) : data(d) { deserialize(data); }
